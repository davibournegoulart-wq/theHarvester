...
Extracted and curated from osintambition/Social-Media-OSINT-Tools-Collection.
165+ specialized OSINT tools categorized across 15+ social networks.
"""
...
ALL_TOOLS: List[Dict[str, Any]] = [
    {
        ...
        "url": "https://apps.crowdtangle.com/chrome-extension",
    ...
    },
    {
        "platform": "LinkedIn",
        "name": "linkedprospect",
        "url": "https://linkedprospect.com/linkedin-boolean-search-tool/#tool",
        "category": "Search & People",
    ...
    },
    {
        ...
        "url": "https://freepeoplesearchtool.com/#gsc.tab=0",
        "category": "Search & People",
        "description": "Find people easily online."
    },
    {
        "platform": "LinkedIn",
        "name": "IntelligenceX Linkedin",
    ...
    },
    {
        ...
        "url": "https://inteltechniques.com/tools/Linkedin.html",
        "category": "Search & People",
    ...
    },
    {
        ...
        "url": "https://airtable.com/appyDhNeSetZU0rIw/shrceHfvukijgln9q/tblxgilU0SzfXNEwS/viwde4ACDDOpeJ8aO?blocks=bipxY3tKD5Lx0wmEU",
        "category": "Media & Scraping",
    ...
    {
        "platform": "Pinterest",
        "name": "Experts PHP: Pinterest Photo Downloader",
    ...
    },
    {
        ...
        "url": "https://www.osintcombine.com/reddit-post-analyser",
        "category": "General Intel",
    ...
    },
    {
        "platform": "Reddit",
        "name": "Phantom Buster",
        "url": "https://phantombuster.com/phantombuster?category=reddit",
        "category": "Media & Scraping",
    ...
    {
        "platform": "Reddit",
        "name": "Readr for Reddit",
        "url": "https://chrome.google.com/webstore/detail/readr-forreddit/molhdaofohigaepljchpmfablknhabmo",
        "category": "General Intel",
    ...
    },
    {
        ...
        "category": "Search & People",
        "description": "Specialized OSINT tool for Reddit"
    },
    {
        "platform": "Reddit",
        "name": "Reddit Shell",
        "url": "https://redditshell.com",
        "category": "General Intel",
    ...
    },
    {
        "platform": "Reddit",
        "name": "Reddit Suite",
        "url": "https://chrome.google.com/webstore/detail/redditenhancementsuite/kbmfpngjjgdllneeigpgjifpgocmfgmb",
        "category": "General Intel",
        "description": "Specialized OSINT tool for Reddit"
    },
    {
    ...
    {
        "platform": "Reddit",
        "name": "Suggest me a subreddit",
        "url": "https://nikas.praninskas.com/suggest-subreddit",
        "category": "General Intel",
    ...
    {
        "platform": "Github",
        "name": "Github Username Search Engine",
    ...
    },
    {
        "platform": "Github",
        "name": "Github Username Search Engine",
        "url": "https://githubnotes-47071.firebaseapp.com/#/?_k=n0bgxn",
        "category": "Search & People",
    ...
    {
        "platform": "Snapchat",
        "name": "Gebruikersnamen: Snapchat",
        "url": "https://gebruikersnamen.nl/snapchat",
        "category": "Search & People",
    ...
    {
        "platform": "Snapchat",
        "name": "OSINT Combine: Snapchat MultiViewer",
    ...
    },
    {
        ...
        "url": "https://github.com/ErikTschierschke/WhatsappMonitor",
        "category": "Activity & Tracking",
    ...
    {
        "platform": "Discord",
        "name": "Unofficial Discord Lookup",
...
def search_social_tools(
    query: Optional[str] = None,
    platform: Optional[str] = None,
    category: Optional[str] = None,
) -> List[Dict[str, Any]]:
    """Filters the OSINT tools collection."""
    results = ALL_TOOLS
    if platform and platform.lower() != 'all':
        p_lower = platform.lower()
        results = [t for t in results if p_lower in t['platform'].lower()]
    if category and category.lower() != 'all':
        c_lower = category.lower()
        results = [t for t in results if c_lower in t['category'].lower()]
    if query:
        q_lower = query.lower()
        results = [
            t for t in results
            ...
            or q_lower in t['platform'].lower()
        ]
    return results

def get_platforms() -> List[str]:
    """Returns distinct available platforms."""
    return sorted(list(set(t['platform'] for t in ALL_TOOLS)))

def get_categories() -> List[str]:
    """Returns distinct available categories."""
    return sorted(list(set(t['category'] for t in ALL_TOOLS)))
