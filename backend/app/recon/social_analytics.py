...
# Open-Source GitHub Repositories for Social Media Monitoring & Analytics
MONITORING_PLATFORMS = [
    {
        "name": "Brandwatch (bcr-api)",
        "git_repo": "git@github.com:BrandwatchLtd/bcr-api.git",
        "url": "https://github.com/BrandwatchLtd/bcr-api",
        "category": "Social Listening & Consumer Intelligence",
        "package_name": "bcr-api>=1.5.1",
        "status": "INSTALLED & DEPLOYED",
        "description": "Official Python client library for the Brandwatch Consumer Research (BCR) API. Ingests conversations across 100M+ web sources, blogs, forums, and social networks with real-time crisis detection and AI sentiment radar.",
        "capabilities": [
            "Official Brandwatch Consumer Research API client",
            "Boolean query validation (BWProject.validate_query_search)",
            "100M+ web sources & social listening coverage",
            "Real-time volume surge & crisis alerts",
            "Demographics & topic co-occurrence mapping",
        ],
        "runner_module": "app.recon.brandwatch_runner",
    },
    {
        "name": "Hootsuite (hootsweet)",
        "git_repo": "git@github.com:ciaranmccormick/hootsweet.git",
        "url": "https://github.com/ciaranmccormick/hootsweet",
        "category": "Social Media Monitoring & Management",
        "package_name": "hootsweet>=0.7.1",
        "status": "INSTALLED & DEPLOYED",
        "description": "Python API wrapper for Hootsuite REST API. Facilitates multi-platform stream listening, profile inspection, post history retrieval, and automated message scheduling.",
        "capabilities": [
            "Official Hootsuite REST API wrapper (HootSweet)",
            "Multi-network profile inspection (get_social_profiles)",
            "Outbound message stream extraction (get_outbound_messages)",
            "Cross-channel publishing & queue analytics",
        ],
        "runner_module": "app.recon.hootsuite_runner",
    },
    {
        "name": "Buffer (buffpy)",
        "git_repo": "git@github.com:bufferapp/buffer-python.git",
        "url": "https://github.com/bufferapp/buffer-python",
        "category": "Scheduling & Cadence Monitoring",
        "package_name": "bufferapp/buffer-python",
        "status": "DEPLOYED",
        "description": "Python client and API interface for Buffer social media management. Analyzes post cadence, queue distribution, URL social share counts across networks, and best posting windows.",
        "capabilities": [
            "Social share tracking across networks (/links/shares.json)",
            "Posting schedule & cadence optimization",
            "Cross-channel engagement rate tracking",
            "Multi-account automated queue management",
        ],
        "runner_module": "app.recon.buffer_runner",
    },
    {
        "name": "Audiense (socialbro-api-python)",
        "git_repo": "git@github.com:SocialBro/socialbro-api-python.git",
        "url": "https://github.com/SocialBro/socialbro-api-python",
        "category": "Audience Intelligence & Segmentation",
        "package_name": "SocialBro/socialbro-api-python",
        "status": "DEPLOYED",
        "description": "Official Python API client for SocialBro / Audiense. Advanced audience segmentation and Twitter/X community intelligence identifying tribe clusters, socio-demographic traits, and influencer affinities.",
        "capabilities": [
        ...
        "runner_module": "app.recon.audiense_runner",
    },
    {
        "name": "Social-Analyzer",
        "git_repo": "git@github.com:qeeqbox/social-analyzer.git",
        "url": "https://github.com/qeeqbox/social-analyzer",
        "category": "Multi-Platform Profile & Social Analytics",
        "package_name": "social-analyzer>=0.45",
        "status": "AVAILABLE",
        "description": "Open source API and CLI tool for analyzing profiles across 300+ social networks and web platforms with advanced extraction modules and pattern analysis.",
        "capabilities": [
            "300+ social media platforms analysis",
            "Automated profile metadata extraction",
            "False positive reduction modules",
            "Multi-platform identity cross-referencing",
        ],
        "runner_module": "external",
    },
]
